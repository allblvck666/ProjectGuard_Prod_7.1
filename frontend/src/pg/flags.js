...
// Новый экран включается только явно — по умолчанию везде "old".
export const FLAG_DEFAULTS = {
  "ui-list": "old",     // Этап 2 — список активных защит
  "ui-detail": "old",   // Этап 3 — карточка защиты
  "ui-create": "old",   // Этап 4 — создание + конфликт
  "ui-nav": "old",      // Этап 5 — нативная навигация Telegram
  "ui-archive": "old",  // Этап 6 — архив защит
  "ui-admin": "old",    // Этап 6 — админка и статистика
